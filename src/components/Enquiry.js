...
const Enquiry = () => {
  ...
  const validateForm = () => {
    ...
    // Email is optional because phone and WhatsApp are the primary booking channels.
    if (
      formData.email.trim() &&
          ...
          >
            ...
            >
              ...
              <div className="field full-width">
                ...
                >
                  <option value="">Select the room you need</option>
                  <option value="2-Occupancy Room">2-Occupancy Room (up to 2 guests)</option>
                  <option value="4-Occupancy Family Room">4-Occupancy Family Room (up to 4 guests)</option>
                  <option value="6-Occupancy Room">6-Occupancy Room (up to 6 guests)</option>
                </select>

                {errors.room && (
                  <span id="room-error" className="error">
                    {errors.room}
                  </span>
                )}
              </div>
              ...
              <p className="privacy-note">
                ...
                Usually fastest: <a href="tel:+919448734152">+91 94487 34152</a>.
              </p>
